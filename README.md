...
`MVC` • `REST APIs` • `Authentication` • `Authorization` • `Middleware` • `Session Management`

---

## 💳 Payments & Integrations
`Razorpay` • `Payment Gateway Integration` • `SMTP` • `Email Automation` • `Live Chat APIs`

---

## 🤖 AI in Development
`Generative AI` • `LLM-assisted Development` • `Prompt Engineering` • `AI Code Optimization`
